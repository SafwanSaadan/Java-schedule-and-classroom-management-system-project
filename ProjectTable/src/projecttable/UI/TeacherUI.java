...
public class TeacherUI extends javax.swing.JFrame {
    ...
    Teacher t = new Teacher();
    List<Teacher> list = t.display();
     DefaultTableModel tabModel = (DefaultTableModel)table_Teacher.getModel();
     Object[] row = new Object[5];
     for (int i = 0; i < list.size(); i++) {
        row[4] = list.get(i).getTeacherId();
        row[3] = list.get(i).getTeacherName();
        row[2] = list.get(i).getTeacherEmail();
        row[1] = list.get(i).getTeacherPhone();
        row[0] = list.get(i).getTeacherActive();
        tabModel.addRow(row);
    }
    ...
    private void clear(){
            ...
            textTeacherEmail.setText("");
            textTeacherPhone.setText("");
            listTeacherActive.setSelectedIndex(0);
    }
    ...
    private void initComponents() {
        ...
        table_Teacher = new javax.swing.JTable();
        listTeacherActive = new javax.swing.JComboBox<>();
        textTeacherEmail = new javax.swing.JTextField();
        labTableName = new javax.swing.JLabel();
        labCorse = new javax.swing.JLabel();
        textTeacherPhone = new javax.swing.JTextField();
        ...
        textTeacherSearch = new javax.swing.JTextField();
        ...
        labMajor.setText("إيميل المدرس");

        table_Teacher.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        table_Teacher.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "حالة المدرس", "رقم الهاتف", "ايميل المدرس", "اسم المدرس", "رقم المدرس"
            }
        ) {
        ...
        table_Teacher.setColumnSelectionAllowed(true);
        table_Teacher.setRowHeight(30);
        jScrollPane1.setViewportView(table_Teacher);
        table_Teacher.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);

        listTeacherActive.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "متوفر", "مشغول" }));

        textTeacherEmail.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textTeacherEmail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textTeacherEmailActionPerformed(evt);
            }
        });
        ...
        labTableName.setText("اسم المدرس");
        ...
        labCorse.setText("رقم الهاتف");

        textTeacherPhone.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textTeacherPhone.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        textTeacherPhone.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textTeacherPhoneActionPerformed(evt);
            }
        });
        ...
        labMajor1.setText("ادخل بيانات المدرس الذي تريد البحث عنها");

        textTeacherName.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        textTeacherSearch.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textTeacherSearch.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        textTeacherSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                textTeacherSearchKeyReleased(evt);
            }
        });
        ...
        jLayeredPane3.setLayer(listTeacherActive, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(textTeacherEmail, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane3.setLayer(textTeacherPhone, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane3.setLayer(textTeacherName, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(textTeacherSearch, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane3Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addComponent(textTeacherSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE)
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textTeacherEmail)
                            .addComponent(listTeacherActive, 0, 249, Short.MAX_VALUE)
                            .addComponent(textTeacherName)
                            .addComponent(textTeacherPhone))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jLayeredPane3Layout.setVerticalGroup(
            ...
            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(textTeacherSearch, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(labMajor)
                            .addComponent(textTeacherEmail, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(textTeacherPhone, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(labCorse))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(listTeacherActive, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(labDay))
                        .addGap(181, 181, 181)
                        .addComponent(bAdd)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void textTeacherEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textTeacherEmailActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textTeacherEmailActionPerformed

    private void textTeacherPhoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textTeacherPhoneActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textTeacherPhoneActionPerformed
    ...
    private void bUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUpdateActionPerformed
        ...
        if(table_Teacher.getSelectedRowCount() == 1){
            String id = tabModel.getValueAt(table_Teacher.getSelectedRow(), 4).toString();
            int teacherId = Integer.parseInt(id);
            String name = textTeacherName.getText();
            String email = textTeacherEmail.getText();
            String ph = textTeacherPhone.getText();
            boolean n = isNumeric(ph);
            int phone ;
           if (n) {
            phone = Integer.parseInt(ph);
            String active = listTeacherActive.getSelectedItem().toString();

            //            وضع القيم في الحقول
            tabModel.setValueAt(name, table_Teacher.getSelectedRow(), 3);
            tabModel.setValueAt(email, table_Teacher.getSelectedRow(), 2);
            tabModel.setValueAt(ph, table_Teacher.getSelectedRow(), 1);
            tabModel.setValueAt(active, table_Teacher.getSelectedRow(), 0);
            Teacher teacher  =  new Teacher(teacherId,name,email,phone,active);
            ...
            System.out.println("الرجاء إدخال أرقام فقط في حقل رقم الهاتف.");
           JOptionPane.showMessageDialog(this, "الرجاء إدخال أرقام فقط في حقل رقم الهاتف");
        }
        }else{
            if(table_Teacher.getSelectedRowCount() == 0){
...
//        frame.pack();
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        if(textTeacherEmail.getText().equals("")|| textTeacherPhone.getText().equals("")
            || textTeacherName.getText().equals("")){

            JOptionPane.showMessageDialog(this, "الرجاء ادخال قيم في الحقول ..");
        }else{
            int id = Database.count("teacher_id","teachers")+1;
            ...
            String data[] = {active,ph,email,name,teacherId};

            DefaultTableModel tabModel = (DefaultTableModel)table_Teacher.getModel();
            tabModel.addRow(data);
            JOptionPane.showMessageDialog(this, "تم إضافة البيانات بنجاح ..");

            Teacher te = new Teacher(id,name,email,phone,active);
            Teacher.addTeacher(te);
    ...
    private void bDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDeleteActionPerformed
        ...
        if(table_Teacher.getSelectedRowCount() == 1){
            ...
            tabModel.removeRow(table_Teacher.getSelectedRow());
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
     ...
     String n = textTeacherSearch.getText();
     search(n);  
    ...
    public void search (String str){
     DefaultTableModel tabModel = (DefaultTableModel)table_Teacher.getModel();
     TableRowSorter<DefaultTableModel> trs = new TableRowSorter<>(tabModel);
     table_Teacher.setRowSorter(trs);
     trs.setRowFilter(RowFilter.regexFilter(str));
    }
    ...
    private void textTeacherSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textTeacherSearchKeyReleased
      String n = textTeacherSearch.getText();
      search(n);
    }//GEN-LAST:event_textTeacherSearchKeyReleased

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        MajorUI c = new MajorUI();
        c.setSize(1366, 750);
        c.setResizable(false);
        c.setVisible(true);
        this.setVisible(false);
    ...
    private javax.swing.JComboBox<String> listTeacherActive;
    private javax.swing.JButton search;
    private javax.swing.JTable table_Teacher;
    private javax.swing.JTextField textTeacherEmail;
    private javax.swing.JTextField textTeacherName;
    private javax.swing.JTextField textTeacherPhone;
    private javax.swing.JTextField textTeacherSearch;
