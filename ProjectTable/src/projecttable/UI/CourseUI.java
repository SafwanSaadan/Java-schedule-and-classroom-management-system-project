...
public void show_Course(){
    Course c = new Course();
    List<Course> list = c.display();
     DefaultTableModel tabModel = (DefaultTableModel)table_Course.getModel();
     Object[] row = new Object[3];
     for (int i = 0; i < list.size(); i++) {
        row[2] = list.get(i).getId(); 
        row[1] = list.get(i).getName();
        row[0] = list.get(i).getMajorName();
 ...
 private void clear(){
    ...
    private void initComponents() {
        ...
        textCourseSearch = new javax.swing.JTextField();
        ...
        table_Course.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        table_Course.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "التخصص", "اسم المادة", "رقم المادة"
            }
        ) {
        ...
        table_Course.setColumnSelectionAllowed(true);
        table_Course.setRowHeight(30);
        jScrollPane1.setViewportView(table_Course);
        table_Course.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);

        listMajor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "IT", "IS", "CS" }));
        ...
        labTableName.setText("اسم المادة");
        ...
        labMajor1.setText("ادخل بيانات المادة التي تريد البحث عنها");

        textCourseName.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textCourseName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textCourseNameActionPerformed(evt);
            }
        });

        textCourseSearch.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textCourseSearch.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        textCourseSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                textCourseSearchKeyReleased(evt);
            }
        });
        ...
        jLayeredPane3.setLayer(textCourseName, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(textCourseSearch, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane3Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addComponent(textCourseSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE)
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(listMajor, 0, 249, Short.MAX_VALUE)
                        ...
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(labDay, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        ...
        jLayeredPane3Layout.setVerticalGroup(
            ...
            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(textCourseSearch, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(textCourseName, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void bUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUpdateActionPerformed
        ...
        if(table_Course.getSelectedRowCount() == 1){
            String id = tabModel.getValueAt(table_Course.getSelectedRow(), 2).toString();
            int courseId = Integer.parseInt(id);
            String name = textCourseName.getText();
            String major = listMajor.getSelectedItem().toString();
            int m = 0;
            if(major== "ِAll"){m = 0;}else if(major== "IT"){m = 1;}else if(major== "BIT"){ m = 2;  }else if(major == "CS"){  m = 3;}else if(major == "IS"){   m = 4;}

                //            وضع القيم في الحقول
                tabModel.setValueAt(name, table_Course.getSelectedRow(), 1);
                tabModel.setValueAt(major, table_Course.getSelectedRow(), 0);
                Course c =  new Course(courseId,name,m);
            ...
            if(table_Course.getSelectedRowCount() == 0){
...
//        frame.pack();
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        if( textCourseName.getText().equals("")){
            ...
            String data[] = {major,name,courseId};

            DefaultTableModel tabModel = (DefaultTableModel)table_Course.getModel();
            tabModel.addRow(data);

            Course c = new Course(id,name,m);
            Course.addCourse(c);
    ...
    private void bDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDeleteActionPerformed
        ...
        if(table_Course.getSelectedRowCount() == 1){
            ...
            tabModel.removeRow(table_Course.getSelectedRow());
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        String n = textCourseSearch.getText();
        search(n);
    ...
    public void search (String str){
        DefaultTableModel tabModel = (DefaultTableModel)table_Course.getModel();
        TableRowSorter<DefaultTableModel> trs = new TableRowSorter<>(tabModel);
        table_Course.setRowSorter(trs);
        trs.setRowFilter(RowFilter.regexFilter(str));
    }
    
    private void textCourseNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textCourseNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textCourseNameActionPerformed

    private void textCourseSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textCourseSearchKeyReleased

        String n = textCourseSearch.getText();
        search(n);
    }//GEN-LAST:event_textCourseSearchKeyReleased
    ...
    private javax.swing.JTextField textCourseSearch;
