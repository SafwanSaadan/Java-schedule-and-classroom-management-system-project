 ...
 * @author Safwan
 */
public class MajorUI extends javax.swing.JFrame {

    /**
     * Creates new form MajorUI
     */
    public MajorUI() {
        initComponents();
        show_Major();
...
public void show_Major(){
    Major m = new Major();
    List<Major> list = m.display();
     DefaultTableModel tabModel = (DefaultTableModel)table_Major.getModel();
     Object[] row = new Object[5];
     for (int i = 0; i < list.size(); i++) {
        row[4] = list.get(i).getMajorId();
        row[3] = list.get(i).getMajorName();
        row[2] = list.get(i).getNumStudent();
        row[1] = list.get(i).getLevelIn();
        row[0] = list.get(i).getDeptName();
        tabModel.addRow(row);
    }               
}
   
 private void clear(){
            textMajorName.setText("");
            listLevel.setSelectedIndex(0);
            textNumStudents.setText("");
            listDept.setSelectedIndex(0);
    }
    ...
    private void initComponents() {
        ...
        table_Major = new javax.swing.JTable();
        listDept = new javax.swing.JComboBox<>();
        textNumStudents = new javax.swing.JTextField();
        ...
        textMajorName = new javax.swing.JTextField();
        textMajorSearch = new javax.swing.JTextField();
        ...
        labMajor.setText("المستوى");

        table_Major.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        table_Major.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "القسم", "عدد الطلاب", "المستوى ", "اسم التخصص", "رقم التخصص"
            }
        ) {
        ...
        table_Major.setColumnSelectionAllowed(true);
        table_Major.setRowHeight(30);
        jScrollPane1.setViewportView(table_Major);
        table_Major.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);

        listDept.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "IT", "CS", "IS" }));

        textNumStudents.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textNumStudents.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textNumStudentsActionPerformed(evt);
            }
        });
        ...
        labTableName.setText("اسم التخصص");
        ...
        labMajor1.setText("ادخل بيانات التخصص التي تريد البحث عنها");

        textMajorName.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textMajorName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textMajorNameActionPerformed(evt);
            }
        });

        textMajorSearch.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textMajorSearch.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        textMajorSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                textMajorSearchKeyReleased(evt);
            }
        });
        ...
        jLayeredPane3.setLayer(listDept, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(textNumStudents, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane3.setLayer(textMajorName, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(textMajorSearch, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane3Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addComponent(textMajorSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(labMajor1, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(5, 5, 5)
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textNumStudents)
                            .addComponent(listDept, 0, 249, Short.MAX_VALUE)
                            .addComponent(textMajorName)
                            .addComponent(listLevel, 0, 249, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(labCorse, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
        ...
        jLayeredPane3Layout.setVerticalGroup(
            ...
            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(textMajorName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(textMajorSearch, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(textNumStudents, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(listDept, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(labDay))
                        .addGap(181, 181, 181)
                        .addComponent(bAdd)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ClassroomUI co = new ClassroomUI();
        co.setSize(1366, 750);
        co.setLocation(0, 0);
    ...
    private void textNumStudentsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textNumStudentsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textNumStudentsActionPerformed
    ...
    private void bUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUpdateActionPerformed
        ...
        if(table_Major.getSelectedRowCount() == 1){
            String id = tabModel.getValueAt(table_Major.getSelectedRow(), 4).toString();
            int majorId = Integer.parseInt(id);
            String name = textMajorName.getText();
            String leve = listDept.getSelectedItem().toString();
            String num = textNumStudents.getText();
            int studentNum;
            boolean n = isNumeric(num);
            if (n) {
                studentNum = Integer.parseInt(num);
                String dept = listDept.getSelectedItem().toString();
                int dep = 0 , level = 0;
                if(dept== "ِAll"){dep = 0;}else if(dept== "IT"){dep = 1;}else if(dept == "CS"){ dep = 2;}else if(dept == "IS"){ dep = 3;}
                if(leve== "1"){level = 1;}else if(leve== "2"){level = 2;}else if(leve == "3"){ level = 3;}else if(leve == "4"){ level = 4;}


                //            وضع القيم في الحقول
                tabModel.setValueAt(name, table_Major.getSelectedRow(), 3);
                tabModel.setValueAt(level, table_Major.getSelectedRow(), 2);
                tabModel.setValueAt(num, table_Major.getSelectedRow(), 1);
                tabModel.setValueAt(dept, table_Major.getSelectedRow(), 0);
                Major m  =  new Major(majorId,name,level,studentNum,dep);
                Major.updateMajor(m);
                ...
                System.out.println("الرجاء إدخال أرقام فقط في حقل عدد الطلاب.");
                JOptionPane.showMessageDialog(this, "الرجاء إدخال أرقام فقط في حقل عدد الطلاب");
            }
        }else{
            if(table_Major.getSelectedRowCount() == 0){
...
//        frame.pack();
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        if(textNumStudents.getText().equals("")|| textMajorName.getText().equals("")){

            JOptionPane.showMessageDialog(this, "الرجاء ادخال قيم في الحقول ..");
        }else{
            int id = Database.count("major_id","majors")+1;
            ...
            if(leve== "1"){level = 1;}else if(leve== "2"){level = 2;}else if(leve == "3"){ level = 3;}else if(leve == "4"){ level = 4;}
                ...
                String data[] = {dept,num,leve,name,majorId};

                DefaultTableModel tabModel = (DefaultTableModel)table_Major.getModel();
                tabModel.addRow(data);

                Major cl = new Major(id,name,level,studentNum,dep);
                Major.addMajor(cl);
    ...
    private void bDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDeleteActionPerformed
        ...
        if(table_Major.getSelectedRowCount() == 1){
            ...
            tabModel.removeRow(table_Major.getSelectedRow());
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        String n = textMajorSearch.getText();
        search(n);
    }//GEN-LAST:event_searchActionPerformed
   public void search (String str){
        DefaultTableModel tabModel = (DefaultTableModel)table_Major.getModel();
        TableRowSorter<DefaultTableModel> trs = new TableRowSorter<>(tabModel);
        table_Major.setRowSorter(trs);
        trs.setRowFilter(RowFilter.regexFilter(str));
    }
    
    private void textMajorNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textMajorNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textMajorNameActionPerformed

    private void textMajorSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textMajorSearchKeyReleased

        String n = textMajorSearch.getText();
        search(n);
    }//GEN-LAST:event_textMajorSearchKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MajorUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> listDept;
    private javax.swing.JComboBox<String> listLevel;
    private javax.swing.JButton search;
    private javax.swing.JTable table_Major;
    private javax.swing.JTextField textMajorName;
    private javax.swing.JTextField textMajorSearch;
    private javax.swing.JTextField textNumStudents;
